...
function SearchSelectWithTableOption(props) {
  const {
      ctrlRef,
      onBlurCb,
      onSelect,
  ...
  return React.createElement(
    ...
    Object.assign(
      {
        ...
        filterOption: false,
        onSearch: lodash.debounce(onFetchUser, 300),
        ...
        dropdownRender: () => {
          if (loading) {
            return React.createElement(
              ...
              React.createElement(Spin, { size: 'small', className: 'm-6 ml-20' }),
            );
          }
          ...
          return React.createElement(Table, {
            ...
            onRow: (record) => {
              return {
                onClick: () => {
                  lodash.isFunction(onSelect) && onSelect(record);
                  setData([]);
    ...
    data.map((item) => React.createElement(Select.Option, { key: item[rowKey] }, item.text)),
  );
  ...
  function getNotFoundContent() {
    if (loading) {
      return React.createElement(Spin, { size: 'small', className: 'm-6 ml-20' });
    }
    if (selectValue && data.length === 0) {
      return React.createElement('div', { className: 'p-10' }, '\u6682\u65E0\u6570\u636E');
    }
    if (data.length === 0) {
      return null;
    }
